...
class MaskRCNN(object):
    ...
    def set_log_dir(self, model_path=None):
        ...
        self.checkpoint_path = os.path.join(self.log_dir, 'best.h5')#jayhsu 20220901

    def train(self, train_dataset, val_dataset, epochs, layers='all',
        ...
        # Callbacks
        callbacks = [
            keras.callbacks.ReduceLROnPlateau(monitor='val_loss', factor=0.5, patience=5, min_lr=0.0000000000001),
        ...
        log(f"log path:{self.log_dir}")
        self.set_trainable(layers)
        self.compile(lr, self.config.LEARNING_MOMENTUM)
